...
.container{
  ...
  width: 30%;
  margin-top: 40px;
  background: linear-gradient(-100deg, #a64141, #f2a0a0);
...
if ($fname!="" && $lname!="" && $username!="" && $password!="") 
{
	...
	$insert = $conn->prepare("INSERT INTO users (fname,lname,username,password) VALUES (:fname,:lname,:username,:password)");
	...
	//echo "<font color='green'>*** DATA SUCCESSFULLY INSERT ***";
}
else
{
